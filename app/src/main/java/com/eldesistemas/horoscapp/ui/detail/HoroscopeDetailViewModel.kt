...
import com.eldesistemas.horoscapp.domain.usecase.GetPredictionUseCase
...
class HoroscopeDetailViewModel
    @Inject constructor(private val getPredictionUseCase: GetPredictionUseCase): ViewModel() {
    ...
    fun getHoroscope(sign: HoroscopeModel) {
        ...
        viewModelScope.launch {
            ...
            if (result != null)
                ...
                _state.value = HoroscopeDetailState.Error("Horoscopo no disponible")
        }
    }
}